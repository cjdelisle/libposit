...
posit_CONST(POSIT_T POSIT_MKNAME(ZERO) = (POSIT_T) { 0 })
posit_CONST(POSIT_T POSIT_MKNAME(NAR) = (POSIT_T) { 1ull<<(POSIT_NBITS- 1) })
posit_CONST(POSIT_T POSIT_MKNAME(MAX) = (POSIT_T) { (1ull<<(POSIT_NBITS- 1)) - 1 })
posit_CONST(POSIT_T POSIT_MKNAME(NEGMAX) = (POSIT_T) { (1ull<<(POSIT_NBITS- 1)) + 1 })
posit_CONST(POSIT_T POSIT_MKNAME(MIN) = (POSIT_T) { 1 })
posit_CONST(POSIT_T POSIT_MKNAME(NEGMIN) = (POSIT_T) { -1ll })
